...
export interface MyBricksTesting {
 ...
 */
export function createMyBricksTesting(params: { collectDebugLogs?: (entry: { type: string; method: string; args: any[]; result?: any }) => void; [key: string]: any }): MyBricksTesting {
  const { env, data, activeEnv, collectDebugLogs } = params;
